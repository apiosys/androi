...
public class GravitySensor extends SensorBaseClass implements SensorEventListener {
    private static String LOG_TAG = GravitySensor.class.getSimpleName();
    ...
    public GravitySensor(Context context) {
        ...
        if(isSensorAvailable(mSensorType, mContext)) {
            Log.i(LOG_TAG, "GRAVITY_SENSOR PRESENT");
