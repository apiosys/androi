...
public class AccelerometerSensor extends SensorBaseClass implements SensorEventListener {
    private static String LOG_TAG = AccelerometerSensor.class.getSimpleName();
    ...
    public AccelerometerSensor(Context context) {
        ...
        if(isSensorAvailable(mSensorType, mContext)) {
            Log.i(LOG_TAG, "ACCELEROMETER PRESENT");
